const FULLTEXT_BY_ID = [
  ...
  \n
  \nMoreover, overexpression of Lmx1a in mouse embryonic stem cells greatly improved their differentiation toward ventral mid- brain DA neurons (Andersson et al., 2006; Cai et al., 2009; Friling et al., 2009), prompting the possibility of using LMX1A modulation
  `,
  `2`,
  `here is some text with a <Link>|/window2/2|[2] `,
]
